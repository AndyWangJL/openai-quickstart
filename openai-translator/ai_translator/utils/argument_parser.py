...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--target_language', type=str, default='Chinese', help='The target language to translate the book to. Default is Chinese.')

    def parse_arguments(self):
        args = self.parser.parse_args()
        if args.model_type == 'OpenAIModel' and not args.openai_model and not args.openai_api_key:
            self.parser.__setattr__('openai_api_key', os.getenv('OPENAI_API_KEY'))
